...
Terra Draw uses [Storybook.js](https://storybook.js.org/) for local user development. This allows developers to quickly visualise and experimenting with different Terra Draw configurations. You can find more information in the [Storybook package README](packages/storybook/README.md).

## Website

The [Terra Draw Website](https://terradraw.io/) acts as a full working implementation of how to use Terra Draw. In this case it is used with popular framework Preact (has very similar API to React). It's [Open Source](https://github.com/JamesLMilner/terra-draw-website) too!
